...
/**
 * A data writer returned by {@link DataWriterFactory#createWriter(int, long, int)} and is
 ...
 * In each retry, {@link DataWriterFactory#createWriter(int, long, int)} will receive a
